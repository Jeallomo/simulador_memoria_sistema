...
class DinamicaCompactacion(QMainWindow):
    ...
    def groupMainWindow(self):
        ...
        self.etiqueta1 = QLabel("DINAMICA CON COMPACTACION")
        self.groupControl = QGroupBox()
        
        self.etiqueta2 = QLabel("Nombre")
        ...
        self.btnRegresar.setGeometry(QRect(5,310,90,25))
...
class tableWidget4(QDialog):
    def __init__(self, parent=None):
        super(tableWidget4, self).__init__(parent)
