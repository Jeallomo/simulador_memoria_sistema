...
class EstaticaVariable(QMainWindow):
    ...
    def groupMainWindow(self):
        ...
        self.etiqueta1 = QLabel("ESTATICA VARIABLE")
        ...
        self.btnRegresar.setGeometry(QRect(5,330,90,25))
...
class tableWidget1(QDialog):
    def __init__(self, parent=None):
        super(tableWidget1, self).__init__(parent)
    ...
    def datosTabla(self):#agrega los datos de los procesos creadas a esta tabla, aqui se muestran los datos de la tabla
    ...
    def eliminarFila(self):#este metodo solo elimina la fila pero tambien deberia eliminar el proceso si se une a la logica
